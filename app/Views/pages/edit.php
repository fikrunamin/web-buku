...
<div class="xl:container mx-auto px-4 mb-16">
    <div class="py-8 flex justify-between items-center">
        <h1 class="text-2xl"><a href="<?=route_to('books.dashboard')?>" class="border-b-2 border-black">Dashboard</a> / Edit <?=$book['judul']?></h1>
    </div>
        ...
        <div class="col-span-2 bg-color-1 p-10">
            <form action="<?= route_to('books.update', $book['id']) ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    ...
                    <input type="file" class="focus:outline-none px-5 py-2 w-full mt-2" name="sampul" >
                ...
                <div class="mb-5">
                    ...
                    <input type="text" class="focus:outline-none px-5 py-2 w-full mt-2" name="judul" placeholder="Masukkan judul" value="<?=old('judul') ?? $book['judul']?>">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" class="focus:outline-none px-5 py-2 w-full mt-2" name="penulis" placeholder="Masukkan penulis" value="<?=old('penulis') ?? $book['penulis']?>">
                ...
                <div class="">
                    ...
                    <div class="h-2"></div>
                    <textarea name="isi" placeholder="Ceritakan isi buku disini" id="editor"><?=old('isi') ?? $book['isi']?></textarea>
